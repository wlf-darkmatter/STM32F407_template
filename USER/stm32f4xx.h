...
/*!< APB2 peripherals *///APB2PERIPH_BASE=0x4001 0000
#define TIM1_BASE             (APB2PERIPH_BASE + 0x0000)
#define TIM8_BASE             (APB2PERIPH_BASE + 0x0400)
#define USART1_BASE           (APB2PERIPH_BASE + 0x1000)//0x4001 1000‬
#define USART6_BASE           (APB2PERIPH_BASE + 0x1400)//0x4001 1400
...
#define USART1              ((USART_TypeDef *) USART1_BASE)//定义USART1为一个指针，其值（指向的地址是USART1_BASE=0x4001 1000‬）
...
/*!< SWS configuration */
#define  RCC_CFGR_SWS                        ((uint32_t)0x0000000C)        /*!< SWS[1:0] bits (System Clock Switch Status)——RCC_CFGR[3:2]位 */
